...
WAR_KEYWORDS = [
    ...
    'наемник', 'контрактник', 'мобилизация', 'мобилизованный', 'призыв', 'военкомат','ОТБОЙ'
    ...
    'Луганск', 'Донецк', 'Мелитополь', 'Бердянск', 'Энергодар', 'Николаев', 'Одесса','осень','парк', 'Осень','парке','тревога по БПЛА','отбой тревоги по БПЛА', 'ОТБОЙ ОПАСНОСТИ АТАКИ БПЛА','ОПАСНОСТЬ АТАКИ БПЛА','анонимно',''
...
STOP_WORDS = [
    ...
    'концерт', 'фестиваль', 'артист', 'группа', 'клип', 'чарт', 'номинация', 'кинофестиваль', 'Открываем ночной чат', 'доброе утро', 'открываем утренний чат','доброй ночи', 'спокойной ночи', 'отбой авиационной опасности','ракетная опасность','ракетной опасности', 'авиационная опасность','авиационной опасности', 'опасность атаки БПЛА','опасности атаки БПЛА',
