...
async def main():
    ...
    async def start_handler(event):
        ...
        await event.reply(
            ...
            "🚫 **Также исключено:** ракетные оповещения, БПЛА, ночные/утренние чаты\n"
            "🚫 **И всякая хуйня:** сезонные красоты, пожелания, капс\n"
            "🚫 **И ОСОБЕННО:** приграничные регионы (Курск, Белгород, Брянск и т.д.)\n\n"
            "✨ Команды:\n"
            "/stop - отписаться\n"
            "/stats - статистика\n"
            "/id - узнать свой ID\n"
